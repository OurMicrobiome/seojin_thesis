...
packages <- c("R.utils", "RColorBrewer", "ape", "assertthat", "checkmate",
              ...
              "pheatmap", "readr", "stringr", "tibble", "tictoc", "tidyr")
for (pkg in packages) {
...
![Differential abundances of all MAGs, organic layer](images/diff_abund_all_o.png)

![Differential abundances of all MAGs, mineral layer](images/diff_abund_all_m.png)

![Differential abundances of 'decomposer' MAGs, organic layer](images/diff_abund_decom_o.png)

![Differential abundances of 'decomposer' MAGs, mineral layer](images/diff_abund_decom_m.png)